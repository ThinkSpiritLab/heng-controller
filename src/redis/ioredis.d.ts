...
declare module "ioredis" {
    ...
    class Command {
        ...
        static setArgumentTransformer(
            name: string,
            fn: (args: IORedis.ValueType[]) => IORedis.ValueType[]
        ): void;
    ...
    namespace IORedis {
        ...
        interface OverloadedHashCommand<T, U> {
            ...
            (arg1: T, arg2: T, cb: Callback<U>): void;
            (
                data: T[] | { [key: string]: T } | Map<string, T>,
                cb: Callback<U>
            ): void;
            (arg1: T, arg2: T, arg3: T, arg4: T, arg5: T, arg6: T): Promise<U>;
            (arg1: T, arg2: T, arg3: T, arg4: T): Promise<U>;
        ...
        interface OverloadedScanCommand<T, U> {
            ...
            (key: string, cursor: number, arg1: T, arg2: T, arg3: T): Promise<
                U
            >;
        ...
        interface Commands {
            ...
            bzpopmin: OverloadedBlockingListCommand<
                KeyType,
                [string, string, string]
            >;

            bzpopmax: OverloadedBlockingListCommand<
                KeyType,
                [string, string, string]
            >;
            ...
            xrevrange: OverloadedKeyCommand<
                ValueType,
                Array<[string, string[]]>
            >;
        ...
        interface Pipeline {
            ...
            bzpopmin(
                ...args: Array<
                    string | number | Callback<[string, string, string]>
                >
            ): Pipeline;
            ...
            exec(
                callback?: Callback<Array<[Error | null, any]>>
